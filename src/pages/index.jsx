	...
	return (
		<ChakraProvider>
			...
			<Text fontSize='lg'>
				...
				Peng X. (2022)
				<strong>
					HUT: Enabling High-UTility, Batched Queries under Differential Privacy
					Protection for Internet-of-Vehicles
				</strong>{' '}
				In arxiv Feb tech report, DOI: https://doi.org/10.48550/arXiv.2202.0649
				<OutboundLink target='_blank' href='https://arxiv.org/abs/2202.06495'>
					[<span style={{ color: 'blue' }}>Detail</span>]
				</OutboundLink>
			</Text>
			<Text fontSize='lg'>
				6. Jin W., Duan Y., Huang S., <strong>Xiong Z.</strong>, Peng X. (2022)
				<strong>
					BROOK Dataset: A Playground for Exploiting Data-Driven Techniques in
					Human-Vehicle Interactive Designs
				</strong>{' '}
				In arxiv Feb tech report, DOI: https://doi.org/10.48550/arXiv.2202.06494
				<OutboundLink target='_blank' href='https://arxiv.org/abs/2202.06494'>
					[<span style={{ color: 'blue' }}>Detail</span>]
				</OutboundLink>
			</Text>
